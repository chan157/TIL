...
![image-20191209151257346](C:UsersAdministratorDesktopTILAzureimages\image-20191209151257346.png)
...
* Gateway 주소 = 라우터의 IP주소
  ...
  * 외부로 통하려면 Gateway 필수
* Network 구조![Network_structure](C:UsersAdministratorDesktopTILAzureimages\Network_structure.jpg)
...
![image-20191209154559178](C:UsersAdministratorDesktopTILAzureimages\image-20191209154559178.png)
...
![Encapsulation_and_DeEncapsulation](C:UsersAdministratorDesktopTILAzureimages\Encapsulation_and_DeEncapsulation.jpg)
...
![Example](C:UsersAdministratorDesktopTILAzureimages\Example.jpg)